...
<body>
    ...
    <header class="header">
        <div class="header-1">
            ...
            <div class="icons">
                ...
                <a href="./backend/login.php" class="fas fa-user"></a>
    ...
    <div class="login-form-container" id="login_back">
        ...
        <form action="./backend/login.php">
            ...
            <p>don't have an account ? <a href="./backend/register.php">create one</a></p>
        </form>
    </div>
